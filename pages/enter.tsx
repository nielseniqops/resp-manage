...
const Enter: NextPage = () => {
    ...
    return (
        ...
        <div className="px-4 mt-10 sm:mt-36 animate__animated animate__backInUp">
            <div className="overflow-hidden bg-green-400 border rounded-md shadow-xl">
                <div className="w-full py-2 mt-1 overflow-hidden text-4xl font-bold text-center text-white bg-black">
                    <h3>NielsenIQ</h3>
                </div>
                <div className="bg-white rounded-b-md">
                    <div className="py-2 border-b-2 border-b-green-400">
